...
module.exports = {
    default: ['us-east-1'],
    // mx-central-1 appended as the per-service lists below do; without it,
    // getS3BucketLocation classifies buckets in that region as 'global'.
    ...
    configservice: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    devopsguru: ['us-east-1', 'us-east-2', 'us-west-1', 'us-west-2','eu-west-1', 'eu-west-2', 'eu-west-3','ap-northeast-1',
        ...
        'sa-east-1'],
    dynamodb: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    docdb: ['us-east-1', 'us-east-2', 'us-west-2', 'ca-central-1', 'eu-central-1', 'eu-west-1',
        ...
        'ap-southeast-2', 'ap-south-1', 'sa-east-1', 'eu-south-1', 'ap-east-1', 'ap-south-2', 'me-central-1', 'mx-central-1'],
    dlm: [...regions, ...newRegionsUpdate],
    dms: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ec2: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ecr: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    eks: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    elb: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    elbv2: [...regions, ...newRegionsUpdate],
    eventbridge: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    emr: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    es: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    glue: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    kinesis: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    firehose: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    kms: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    vpc: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    flowlogs: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    rds: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    redshift: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    cloudwatch: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ecs: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    resourcegroupstaggingapi: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    sagemaker: [...regions, ...newRegionsUpdate],
    secretsmanager: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    sts: ['us-east-1'],
    transfer: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    lambda: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    directoryservice: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    efs: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    support: ['us-east-1'],
    wafregional: regions,
    wafv2: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    waf: ['us-east-1'],
    organizations: ['us-east-1'],
    guardduty: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    servicequotas: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    xray: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    mq: [...regions, 'ap-south-2', 'ap-southeast-4', 'eu-south-2', 'eu-central-2', 'il-central-1', 'mx-central-1'],
    glacier: regions,
    backup: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    elasticache: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    fsx: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    ...
    imagebuilder: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    computeoptimizer: ['us-east-1'],
    appconfig: [...regions, ...newRegionsUpdate, 'mx-central-1'],
    opensearch: [...regions, ...newRegionsUpdate, 'mx-central-1'],
